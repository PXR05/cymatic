...
object LauncherStore {
    ...
    private val CLOCK_SHORTCUT_ENABLED_KEY = booleanPreferencesKey("CLOCK_SHORTCUT_ENABLED")
    private val CALENDAR_SHORTCUT_ENABLED_KEY = booleanPreferencesKey("CALENDAR_SHORTCUT_ENABLED")
    ...
    val clockShortcutEnabledFlow: Flow<Boolean>
        get() = store.data.map { it[CLOCK_SHORTCUT_ENABLED_KEY] ?: true }

    val calendarShortcutEnabledFlow: Flow<Boolean>
        get() = store.data.map { it[CALENDAR_SHORTCUT_ENABLED_KEY] ?: true }

    fun setClockShortcutEnabled(value: Boolean) {
        scope.launch { store.edit { it[CLOCK_SHORTCUT_ENABLED_KEY] = value } }
    }

    fun setCalendarShortcutEnabled(value: Boolean) {
        scope.launch { store.edit { it[CALENDAR_SHORTCUT_ENABLED_KEY] = value } }
    }
